...
namespace ChefNear.Infrastructure.Migrations
{
    ...
    [Migration("20260808190834_AddDeliveryFeeAndOrderFulfillmentTypeColumnsToOrders")]
    partial class AddDeliveryFeeAndOrderFulfillmentTypeColumnsToOrders
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ChefNear.Domain.Entities.Order", b =>
                {
                    ...
                    b.Property<string>("OrderFulfillmentType")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
